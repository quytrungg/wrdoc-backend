...
DEFAULT_FROM_EMAIL = decouple.config(
    "DEFAULT_FROM_EMAIL",
    default="no-reply@wrdoc-backend.com",
)
SERVER_EMAIL = decouple.config("SERVER_EMAIL", default=DEFAULT_FROM_EMAIL)
...
ZOOM_VIDEO_APP_KEY = decouple.config("ZOOM_VIDEO_APP_KEY")
ZOOM_VIDEO_SECRET_KEY = decouple.config("ZOOM_VIDEO_SECRET_KEY")
